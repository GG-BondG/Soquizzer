...
- `src/`, `main.py`, `requirements.txt` — Gemini API IO 模块的 Python
  最小示例（详见根目录 README）。/ Python minimal example for the Gemini
  API IO module (see the root README for details).
