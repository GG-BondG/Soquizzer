"""
Codex 独立版本："结构衔接题" (structural checkpoint questions) 提示词实验脚本。
...
跑法 / Run:
    python codex-experiment/quiz_prompt_experiment_codex.py "D:\\Download\\READINGs\\complete-induction-I.pdf"
"""
...
def main() -> None:
    ...
    if len(sys.argv) < 2:
        print("用法 / Usage: python codex-experiment/quiz_prompt_experiment_codex.py <path-to-pdf>")
        sys.exit(1)
